...
enum Camera_Movement {
    ...
    LEFT,
    RIGHT,
    UP, //added for q and e movements
    DOWN //added for q and e movements
};
...
float MovementSpeed; //adjustable speed with scroll wheel
...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime)
    {
        ...
        if (direction == RIGHT)
            Position += Right * velocity;
        if (direction == UP) //added upward camera movement
            Position += Up * velocity;
        if (direction == DOWN) //added downward camera movement
            Position -= Up * velocity;
    }
    ...
    void ProcessMouseScroll(float yoffset)
    {
        ...
        //adjust movement speed based on mouse scroll
        MovementSpeed = 1.0f + (45.0f - Zoom) * 0.4f;
    }
